...
object DialogUtils {
    ...
    fun confirmationDialog(context: Context?, titleId: Int, messageId: Int, confirmAction: Action) {
        confirmationDialog(
            context,
            titleId,
            messageId,
    ...
    private fun confirmationDialog(
        context: Context?, titleId: Int, messageId: Int, confirmAction: Action, cancelAction: Action
    ) {
    ...
    fun showImportExportDialog(
        context: Context?, titleId: Int, importAction: Action, exportAction: Action
    ) {
        val importOption = 0
        val exportOption = 1
        val options = arrayOf(
