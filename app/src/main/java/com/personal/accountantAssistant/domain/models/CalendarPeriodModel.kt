...
data class CalendarPeriodModel(private var start: Calendar?, private var end: Calendar?) {
    ...
    companion object {
        fun initDefaultPeriodDates(): CalendarPeriodModel {
            ...
            return CalendarPeriodModel(currentMonth, nextMonth)
        }
    }
